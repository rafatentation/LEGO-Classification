...
**Kaynak:** [Kaggle - LEGO Parts Dataset]([https://www.kaggle.com/datasets/joosthazelzet/lego-brick-images](https://www.kaggle.com/datasets/ihelon/lego-minifigures-classification?select=test))  
**Açıklama:**  
